...
"thumbnailUrl": thum,
"thumbnail": thum,
"sourceUrl": "https://youtu.be/oenqnFbitmI"
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© HUMANBOT ~ Tata", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© HUMANBOT ~ Tata", log0, btn, thum)
}
...
thumbnail: log0,
mediaType:2,
mediaUrl: "https://youtu.be/oenqnFbitmI",
sourceUrl: "https://youtu.be/oenqnFbitmI"
}}
}
sock.sendMessage(m.chat, buttonMessage, { quoted: m })
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Tata Official ~ Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Tata Official ~ Facebook Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Tata Official ~ Tiktok Downloader",
body:res.title,
thumbnail: log0,
mediaType:1,
mediaUrl: args[0],
